...
def grafik():
    avg_rentals_day_2011 = pd.read_csv('./dashboard/avg_rentals_day_2011.csv')
    avg_rentals_day_2012 = pd.read_csv('./dashboard/avg_rentals_day_2012.csv')
    ...
    if tahun_terpilih == 2011:
        data_terpilih = avg_rentals_day_2011
    else:
        data_terpilih = avg_rentals_day_2012
    ...
    if not filtered_data.empty:
        ...
        sns.lineplot(data=filtered_data, x="day", y="count", hue="season", marker="o", ax=ax)
